...
if (dhwc_is_active() && !class_exists('DHWCLookbook')){
	class DHWCLookbook {
		...
		public function register_taxonomy(){
			...
			$product_lookbok_slug = empty( $permalinks['lookbok_base'] ) ? _x( 'product-lookbok', 'slug', DH_DOMAIN ) : $permalinks['lookbok_base'];
			...
			register_taxonomy ( 'product_lookbook', 
				...
				apply_filters ( 'dhwc_taxonomy_args_product_lookbok', array (
					...
					'label' => __ ( 'Product Lookbooks', DH_DOMAIN ),
					'labels' => array (
							'name' => __ ( 'Product Lookbooks', DH_DOMAIN ),
							'singular_name' => __ ( 'Product Lookbook', DH_DOMAIN ),
							'menu_name' => _x ( 'Lookbooks', 'Admin menu name', DH_DOMAIN ),
							'search_items' => __ ( 'Search Product Lookbooks', DH_DOMAIN ),
							'all_items' => __ ( 'All Product Lookbooks', DH_DOMAIN ),
							'parent_item' => __ ( 'Parent Product Lookbook', DH_DOMAIN ),
							'parent_item_colon' => __ ( 'Parent Product Lookbook:', DH_DOMAIN ),
							'edit_item' => __ ( 'Edit Product Lookbook', DH_DOMAIN ),
							'update_item' => __ ( 'Update Product Lookbook', DH_DOMAIN ),
							'add_new_item' => __ ( 'Add New Product Lookbook', DH_DOMAIN ),
							'new_item_name' => __ ( 'New Product Lookbook Name', DH_DOMAIN ) 
					),
					'show_ui' => true,
