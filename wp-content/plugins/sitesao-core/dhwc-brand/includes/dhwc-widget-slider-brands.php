...
class DHWC_Widget_Brand_Slider extends WP_Widget {
	...
	public function __construct(){
		$widget_options = array( 'classname' => 'dhwc_widget_brand_slider', 'description' => __( 'Shows product brans with slider',DH_DOMAIN) );
		$control_options = array();
		parent::__construct('dhwc_widget_brand_slider',__('DHWOO Product Brand Slider',DH_DOMAIN), $widget_options, $control_options);
	...
	public function form($instance){
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e('Title:', DH_DOMAIN) ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('orderby'); ?>"><?php _e( 'Order by:', DH_DOMAIN ) ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('hide_empty'); ?>"><?php _e( 'Hide empty brands', DH_DOMAIN ); ?></label>
		</p>
		<?php
	}
}