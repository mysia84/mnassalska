<?php
if ( ! class_exists( 'DHCategoryDropdown' ) ) :

	class DHCategoryDropdown extends Walker {
...
if ( ! class_exists( 'DHWalker' ) ) :

	class DHWalker extends Walker_Nav_Menu {
...
if ( ! class_exists( 'DHUnderlineWalker' ) ) :

	class DHUnderlineWalker extends DHWalker {
...
if ( ! class_exists( 'DHMegaWalker' ) ) :

	class DHMegaWalker extends DHWalker {
