...
<form class="cart" method="post" enctype='multipart/form-data'>
			...
			<?php
				foreach ( $grouped_products as $product_id ) :
					...
					<tr>
						...
						<td class="price">
							<?php
								echo dhecho($product->get_price_html());
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button type="submit" class="single_add_to_cart_button button alt"><?php echo dhecho($product->single_add_to_cart_text()); ?></button>
